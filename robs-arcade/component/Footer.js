...
export default function Footer() {
  return (
    <>
    <nav style={{ bottom: '0%', position: 'fixed', width: '99%', background: '#210062' ,border: 'solid #F9D949 3px', display: 'flex', justifyContent: 'space-evenly' }} >
    {/* <div style={{ border: 'solid #F9D949 3px', display: 'inline' }} >
      ...
      <div style={{ border: 'solid #F9D949 2px', display: 'inline', display: 'inline', margin: '2px', padding: '2px' }} >
